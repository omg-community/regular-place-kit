...
public enum Text {
	...
	public static void drawStringCentered(String text, Location location, Material material, Direction direction,
			String textID) {
	...
	public static void destroyString(String textID) {
		List<Location> drawnList = drawnText.get(textID);
		if (drawnList != null)
			for (Location l : drawnList)
				l.getBlock().setType(Material.AIR);
	}

	public static void destroyAllStrings() {
		for (String textID : drawnText.keySet())
			destroyString(textID);
	}
